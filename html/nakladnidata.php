						...
						echo "<table>";
							...
							echo "<TR valign='top'>";
								...
								//Загружені документи
									...
									$TableInfo = new TableInfo($FormNakladniItem3." ".$From." ".$_REQUEST["Date1"]." ".$To." ".$_REQUEST["Date2"]); //Створюю і вивожу інформативний блок з таблицею $Table->Show()
								...
								//Вигружені документи
									...
									$TableInfo = new TableInfo($FormNakladniItem4." ".$From." ".$_REQUEST["Date1"]." ".$To." ".$_REQUEST["Date2"]); //Створюю і вивожу інформативний блок з таблицею $Table->Show()
									$TableInfo->ChangeBorder(2);
									$TableInfo->AddBody($Table->Show());
									echo $TableInfo->Show();
									echo $Table->ShowMenu();
