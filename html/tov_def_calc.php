						...
						//Таблиця з дефектурою
							echo "<TR>";
								echo "<TD align='center'>";
									...
									$TableData = $DataModule->GetAllTovarWithOborot($_REQUEST["Date1"],$_REQUEST["Date2"], $_REQUEST["Period"]);
									echo "<font class='Midle'>".$FormTovarItem5."</font>";
									$Table = new Table();
									echo $Table->TableBegin(count($TableData[1])+1);
									$Row = array($FormTovarDefecturaItem1, $FormTovarItem2, $FormTovarDefecturaItem2, $FormTovarDefecturaItem9, $FormTovarDefecturaItem7, $FormTovarDefecturaItem8, $FormTovarDefecturaItem6);
									...
									for ($i=1; $i<=count($TableData); $i++)
									{
										...
										";
										$Row = array($TableRow[1], $TableRow[8], $TableRow[2], $TableRow[3], $TableRow[4], $TableRow[5], $Value);
										echo $Table->TableRow($Row);
									}
