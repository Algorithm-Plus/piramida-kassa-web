...
echo "<title>".$FormCheckItem2." ".$_SESSION["AptekaList"][$_SESSION["CurrentApteka"]]->MnemoCod." </title>";
...
//---------------------------Дані на сторінці
						...
						echo "<BR>";
							...
							$TableData = $DataModule->ChangeCheckPayType($_REQUEST["id"]);
						echo $FormCheckItem3." ".$_REQUEST["id"]."";
